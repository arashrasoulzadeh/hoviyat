...
func TestAuditLogRepository_FindByID(t *testing.T) {
	...
	require.NoError(t, err)
	require.Equal(t, log.ID, found.ID)
	require.Equal(t, log.EventType, found.EventType)
}
...
func TestAuditLogRepository_FindByID_NotFound(t *testing.T) {
	...
	require.ErrorIs(t, err, domain.ErrAuditLogNotFound)
}
...
func TestAuditLogRepository_List(t *testing.T) {
	...
	require.Equal(t, domain.AuditEventTypeUserLogin, logs[0].EventType)

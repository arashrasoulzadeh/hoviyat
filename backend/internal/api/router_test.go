...
func newTestRouter() (*gin.Engine, *fakeTenantRepository) {
	...
	return api.NewRouter(authHandler, userHandler, tenantHandler, teamHandler, authzHandler, nil, nil, nil, nil, nil, nil, nil, tokens, rbac, tenantSignupLimiter), tenants
}
